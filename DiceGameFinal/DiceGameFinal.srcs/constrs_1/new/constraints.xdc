...
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { in_p2[0] }]; IO_L24N_T3_RS0_15 Sch=in_p2[0]
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { in_p2[1] }]; IO_L3N_T0_DQS_EMCCLK_14 Sch=in_p2[1]
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { in_p2[2] }]; IO_L6N_T0_D08_VREF_14 Sch=in_p2[2]
...
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { in_p1[0] }]; IO_L20P_T3_A08_D24_14 Sch=in_p1[0]
set_property -dict { PACKAGE_PIN U11   IOSTANDARD LVCMOS33 } [get_ports { in_p1[1] }]; IO_L19N_T3_A09_D25_VREF_14 Sch=in_p1[1]
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { in_p1[2] }]; IO_L21P_T3_DQS_14 Sch=in_p1[2]
